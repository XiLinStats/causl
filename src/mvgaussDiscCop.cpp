...
// [[Rcpp::export]]
arma::vec dGDcop_sig_bin(arma::mat const &x,
                     arma::cube const &sigma,
                     arma::mat const &trunc,
                     bool const logd = false) {
  ...
  arma::vec out(n);
  arma::rowvec z;
  uword const p = sigma.n_rows - q;   // p = no of cts components
  // Rprintf("p = %i\n", p);
